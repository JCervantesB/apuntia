          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            >
              ...
              <div className="flex flex-col gap-6 mt-4 px-6 py-4">
                <Link href="/dashboard" onClick={handleClose} className="text-base font-medium text-gray-800 hover:underline">
                  Mis Apuntes
                </Link>
                <Link href="/research" onClick={handleClose} className="text-base font-medium text-gray-800 hover:underline">
                  Investigación
                </Link>
                <Link href="/upload" onClick={handleClose} className="text-base font-medium text-gray-800 hover:underline">
                  Subir PDF
                </Link>

                {user && (
                  <div className="flex flex-col gap-4 border-t pt-4 mt-6">
                    <Link href="/panel" onClick={handleClose} className="text-base text-gray-800 hover:underline">
                      Configuración
                    </Link>
                    <SignOutButton>
