        ...
        <CollapsibleContent className='h-[50vh]'>
          <Tabs defaultValue="activities" className="w-full h-full shadow-md">
            <TabsList className='w-full px-2 py-6'>
              <TabsTrigger value="activities" className='flex-1 shadow-none border-black/10 border-solid p-3'>Actividades</TabsTrigger>
              {
                sources.length > 0 && <TabsTrigger value="sources">Fuentes</TabsTrigger>
              }
            </TabsList>
